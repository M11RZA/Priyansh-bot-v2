...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == "i hate you") || (event.body.toLowerCase() == "hate you")) {
      ...
      if ((event.body.toLowerCase() == "Chutiye") || (event.body.toLowerCase() == "chutiye bot") || (event.body.toLowerCase() == "chumtiya bot") || (event.body.toLowerCase() == "chumtiye bot")) {
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me Sameer ki setting hu", threadID);
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝𝐒𝐚𝐦𝐞𝐞𝐫 𝐊𝐡𝐚𝐧🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐒𝐚𝐦𝐢. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/𝙈𝙍.𝙎𝘼𝙈 345☞    his insta id @SAMEER345 ☜ ༺༒ ༒", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "love you")) {     return api.sendMessage("️️️ITNE MUJHE I LOVE YOU BOL RHI HO MERE BOSS 𝐒𝐀𝐌𝐄𝐄𝐑 KHAN URF SA𝐌 KO BOLO BAHUT HI ACHA BNDA HAI MERA BOSS ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("😻 ✄𝐢𝐒 𝐍𝐚𝐳𝐚𝐑 𝐒𝐄 𝐌𝐞𝐑𝐞 𝐎𝐰𝐧𝐞𝐑 𝐒𝐚𝐦𝐞𝐞𝐑 𝐊𝐨 𝐃𝐞𝐤𝐡𝐎🌬️☞𝐦𝐚𝐣𝐚 𝐍𝐚 𝐀𝐘𝐞 😻 𝐭𝐎 𝐏𝐚𝐢𝐒𝐞 𝐖𝐚𝐩𝐢𝐒 🧡>³••🕊️🍎😍 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😎")) {return api.sendMessage("🌬️ ✄𝐂𝐡𝐚𝐒𝐦𝐚_𝐇𝐚𝐓𝐚𝐎_𝐧𝐚_𝐒𝐚𝐡𝐚𝐁_𝐊𝐢𝐘𝐚_𝐍𝐚𝐦𝟑_𝐇𝐚𝐢_𝐀𝐩𝐊𝐚 😅", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤩")) {return api.sendMessage("𝐊𝐀𝐀𝐍𝐈𝐘𝐀 𝐇𝐀𝐈 𝐊𝐘𝐀 𝐉𝐎 𝐃𝐈𝐍 𝐌𝐄 𝐓𝐀𝐑𝐄 𝐍𝐀𝐙𝐀𝐑 𝐀𝐑𝐇𝐄 𝐇𝐀𝐈𝐍 😂😂😂 ", threadID);
    };
  ...
  if ((event.body.toLowerCase() == "🤐")) {
    ...
    if ((event.body.toLowerCase() == "😉") || (event.body.toLowerCase() == "😉")) {
     ...
     if ((event.body.toLowerCase() == "😱") || (event.body.toLowerCase() == "😨")) {
       return api.sendMessage("️🦋⃝⸺‣𝐊𝐢𝐘𝐚 𝐇𝐔𝐚 😱 𝐒𝐇𝐞𝐒𝐇𝐚 𝐃𝐞𝐊𝐇 𝐊𝐢𝐘𝐚 𝐊𝐢𝐘𝐚 😳", threadID);
     };

    if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
       return api.sendMessage("️️𝐓𝐄𝐑𝐈 𝐓𝐎𝐅𝐅𝐈 𝐋𝐄𝐋𝐈 𝐊𝐈𝐒𝐈𝐍𝐄 𝐉𝐎 𝐀𝐈𝐒𝐀 𝐌𝐔𝐇 𝐁𝐀𝐍𝐀 𝐋𝐈𝐘𝐀", threadID);
     };
