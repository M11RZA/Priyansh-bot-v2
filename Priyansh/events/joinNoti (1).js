...
module.exports.run = async function({ api, event }) {
        ...
        if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
                ...
                const fs = require("fs");
                return api.sendMessage("Assalamu Alaikum Everyone🥀🥀", event.threadID, () => api.sendMessage({body:`🌺🧡↻𝐒𝐀𝐌𝐄𝐄𝐑↻🧡🌺 CONNECTED«
...
💐𝐁𝐀𝐁𝐘 𝐌𝐔𝐉𝐄 𝐌𝐄𝐑𝐄 𝐁𝐎𝐒𝐒 𝐒𝐀𝐌𝐄𝐄𝐑 𝐍𝐄 𝐁𝐀𝐍𝐀𝐘𝐀 𝐇𝐀𝐈💐

💐𝐄𝐌𝐀𝐈𝐋💐: skm302383@gmail.com

💐𝐑𝐄𝐀𝐋𝐓𝐈𝐎𝐍𝐒𝐇𝐈𝐏💐:  Ç𝐎𝐌𝐌𝐈𝐓𝐄𝐃`, attachment: fs.createReadStream(__dirname + "/cache/Messenger_creation_686F428A-1E47-4059-9A2D-5EC923DF31B5.mp4")} ,threadID));
        }
        else {
                try {
